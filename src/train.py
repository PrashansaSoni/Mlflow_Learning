...
import mlflow
os.environ["MLFLOW_TRACKING_URI"]="https://dagshub.com/PrashansaSoni/machinelearningpipeline.mlflow"
os.environ["MLFLOW_TRACKING_USERNAME"]="PrashansaSoni"
os.environ["MLFLOW_TRACKING_PASSWORD"]="b5888c815027dd5edb853a5d063aaf734aa6f7cc"
...
def train(data_path,model_path,random_state,n_estimators,max_depth):
    ...
    mlflow.set_tracking_uri("https://dagshub.com/PrashansaSoni/machinelearningpipeline.mlflow")
    ...
    with mlflow.start_run():
        ...
        print(f"Accuarcy score:{accuracy}")
